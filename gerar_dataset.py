...
# 1 = periferia, 2 = zona intermediaria, 3 = centro / bairro nobre

bonus_localizacao = np.where(localizacao == 1, 0,
                    np.where(localizacao == 2, 40000, 100000))

# preco com relacoes nao-lineares para dificultar o ajuste linear
...
preco = (
    ...
    + banheiros * 10000
    - idade     * 2000
    - (idade ** 1.4) * 400   # casas muito velhas perdem valor mais rapido
    + garagem   * 20000
    + bonus_localizacao
    + 50000
    + ruido
...
# remover outliers com z-score nas colunas principais
